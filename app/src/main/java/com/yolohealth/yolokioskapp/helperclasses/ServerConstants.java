...
//	public static String SERVER_ADDRESS = "http://192.168.31.150/api";
	...
	public static String HEALTHPROGRAMS="/HealthPrograms";
	public static String BODYVITALS="/BodyVitals";

//	Prod
	public static final String APP_ID = "28827";
	public static final String AUTH_KEY = "N5mMwKV893pjhxu";
	public static final String AUTH_SECRET = "POR3XQNVp2WXVWP";
	public static final String ACCOUNT_KEY = "K5vdM8zVB2R2MsGfT3NH";

	//Debug
//	public static final String APP_ID = "23434";
//	public static final String AUTH_KEY = "TWWeEdjpjgjRqsA";
//	public static final String AUTH_SECRET = "DCkPTGCvnFNKwHn";
//	public static final String ACCOUNT_KEY = "qzpRnpyzMfvWgfx9qyGA";
	...
	public final static int CALL_ACCEPT_BY_USER = 11116;
